...
import 'doctor_question1_screen.dart';

class Question3Screen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _Question3ScreenState();
  String caseId;

  Question3Screen({required this.caseId});
}

class _Question3ScreenState extends State<Question3Screen> {
  TextEditingController patientSpeciesController = TextEditingController();
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        controller: patientSpeciesController,
                        cursorHeight: 20,
              ...
              child: Row(
                children: [
                  ...
                  Container(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        if (patientSpeciesController.text.isEmpty) {
                          ToastMessage.showToastMessage(
                            context: context,
                            message: 'Please enter patient species',
                            duration: 3,
                            backColor: Colors.red,
                            position: StyledToastPosition.center,
                          );
                        } else {
                          _submitAnswer(patientSpeciesController.text.toString(), "2", this.widget.caseId);
                        }
                      },
                      child: Container(
                        height: 34,
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonData['status']['error'] == false) {
          ...
          patientSpeciesController.text = jsonData['data']['answers'][1]['answers'] != null ? jsonData['data']['answers'][1]['answers'] : '';
          setState(() {});
        } else {
          Navigator.of(_keyDialog.currentContext!, rootNavigator: true).pop();
          ToastMessage.showToastMessage(
