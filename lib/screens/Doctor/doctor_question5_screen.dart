...
import 'doctor_question4_screen.dart';
import 'doctor_question6_screen.dart';
import 'package:http/http.dart' as http;

class Question5Screen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _Question5ScreenState();
  String caseId;

  Question5Screen({required this.caseId});
}
...
class _Question5ScreenState extends State<Question5Screen> {
  ...
  List<String> listOfValue = ['Male', 'Female', "Unknown"];
  var _selectedValue;
                    ...
                    child: GestureDetector(
                      onTap: () {
                        if (_selectedValue != null) {
                          _submitAnswer(_selectedValue, "5", this.widget.caseId);
                        } else {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonData['status']['error'] == false) {
          ...
          _selectedValue = jsonData['data'][4]['answers'] != null ? jsonData['data'][4]['answers'] : null;
          setState(() {});
        } else {
          Navigator.of(_keyDialog.currentContext!, rootNavigator: true).pop();
          ToastMessage.showToastMessage(
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonData['status']['error'] == false) {
          ...
          Navigator.pushReplacement(
            context,
            PageTransition(
              child: Question6Screen(caseId: this.widget.caseId),
