class SpecialistPendingCaseModel {
  Status? status;
  List<Data>? data;

  SpecialistPendingCaseModel({this.status, this.data});

  SpecialistPendingCaseModel.fromJson(Map<String, dynamic> json) {
    status =
...
class Data {
  ...
  Null? specialistExperience;
  Null? disputeCause;
  Null? disputeDescription;
  String? video;
  String? createdAt;
  String? updatedAt;
  String? baseTime;
