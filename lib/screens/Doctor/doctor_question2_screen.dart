...
class Question2Screen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _Question2ScreenState();
  String caseId;

  Question2Screen({required this.caseId});
}
                    ...
                    child: GestureDetector(
                      onTap: () {
                        if (patientNameController.text.isEmpty) {
                          ...
                          _submitAnswer(patientNameController.text.toString(), "2", this.widget.caseId);
                        }
                      },
                      child: Container(
                        height: 34,
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonData['status']['error'] == false) {
          ...
          patientNameController.text = jsonData['data'][1]['answers'] != null ? jsonData['data'][1]['answers'] : '';
          setState(() {});
        } else {
          Navigator.of(_keyDialog.currentContext!, rootNavigator: true).pop();
          ToastMessage.showToastMessage(
