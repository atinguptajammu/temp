...
import 'doctor_question9_screen.dart';
import 'package:http/http.dart' as http;

class Question8Screen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _Question8ScreenState();
  String caseId;

  Question8Screen({required this.caseId});
}
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    Container(
                      child: Text(
                        "Veterinarian's Primary Concern.",
                        textAlign: TextAlign.center,
                    ...
                    Container(
                      child: Text(
                        "What problem/question/concern can a Specialist help with?",
                        textAlign: TextAlign.center,
              ...
              child: Row(
                children: [
                  ...
                  Container(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        if (primaryController.text.isEmpty) {
                          ...
                          _submitAnswer(primaryController.text.toString(), "8", this.widget.caseId);
                        }
                      },
                      child: Container(
                        height: 34,
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonData['status']['error'] == false) {
          ...
          primaryController.text = jsonData['data'][7]['answers'] != null ? jsonData['data'][7]['answers'] : '';
          setState(() {});
        } else {
          Navigator.of(_keyDialog.currentContext!, rootNavigator: true).pop();
          ToastMessage.showToastMessage(
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonData['status']['error'] == false) {
          ...
          Navigator.pushReplacement(
            context,
            PageTransition(
              child: Question9Screen(caseId: this.widget.caseId),
